...
This project is an opportunity to showcase what you've learned so far, so it
is important that HTML, CSS and JavaScript are incorporated into the project
in some way.

The content, styling, and functionality of your site is up to you. Keep in mind
...
editor, this routine might look sometthing like the following:
...
each one, you can verify everying this working so when you _do_ make a mistake,
you'll know it was made recently.

## Professional Git Development Workflow

When it comes to Git, there is ultimately no rule that says you _must_ do thngs
a certain way. However, if there was anything we could impart on you regarding
...
there are many developers working on large code bases - in these cases, limiting
